...
public class PokemonRestController {
    ...
    // add mapping for GET /pokemon/{pokemonId}
    ...
    // add mapping for PUT /pokemons - update existing pokemons

    @PutMapping("/pokemons")
    public Pokemon updatePokemons(@RequestBody Pokemon thePokemon) {
    ...
    // add mapping for PATCH /pokemons/{pokemonId} - patch employee ... partial
    // update
